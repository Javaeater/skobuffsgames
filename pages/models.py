...
class Room(models.Model):
    ...
    ana_word = models.CharField(max_length=10, default="starter")
    all_words = models.CharField(max_length=500000)
    points = models.IntegerField(null=False, default=0)
    final_words = models.CharField(max_length=500000, default=" ")
